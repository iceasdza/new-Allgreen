...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Shop Single | Canvas</title><!DOCTYPE html>
<html dir="ltr" lang="en-US">
<head>
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					<li><a href="/">Home</a></li>
					<li><a href="/catagoryID={{$product->CatagoriesID}}">Shop</a></li>
							...
							<div class="col_two_fifth product-desc">
								...
								<div class="panel panel-default product-meta">
									<div class="panel-body">
										...
										<span class="posted_in">Category: <a href="/catagoryID={{$product->CatagoriesID}}" rel="tag">{{$cat->catagoriesName}}</a>.</span>
										@endforeach
										</div>
							...
							<div class="col_two_fifth product-desc">
								...
								<div class="panel panel-default product-meta">
									<div class="panel-body">
										...
										<span class="posted_in">Category: <a href="/admin/catagoriesID={{$product->CatagoriesID}}" rel="tag">{{$cat->catagoriesName}}</a>.</span>
										@endforeach
										</div>
								</div><!-- Product Single - Meta End -->
